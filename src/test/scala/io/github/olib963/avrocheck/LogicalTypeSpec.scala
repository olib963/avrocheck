...
class LogicalTypeSpec extends SchemaGeneratorSpec {
  override val schemaFile = "record-with-logical-types.avsc"

  describe("Schema based generator") {
    it("should reject all logical type schemas") {
      val logicalTypeSchemas = List(
